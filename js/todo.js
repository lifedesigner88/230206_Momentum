...
function paintToDo(newTodoObj) {
  ...
  toDoButton.style.marginLeft = "8px";
  toDoButton.style.borderRadius = "10px";
  toDoButton.style.border = "0";
  toDoButton.style.paddingBottom = "4px";
  toDoButton.style.backgroundColor = "rgba(255, 255, 255, 0.6)";
